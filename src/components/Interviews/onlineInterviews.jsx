  ...
  useEffect(() => {
    const fetchInterviews = async () => {
      ...
      try {
        ...
        const res = await axios.get('http://ats-env.eba-9hjpmsgu.us-east-1.elasticbeanstalk.com/api/online-interviews', {
    ...
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1200, margin: '0 auto' }}>
      ...
      {filteredInterviews.length === 0 ? (
        <Paper elevation={0} sx={{
          ...
          <Button
            variant="contained" size="large" startIcon={<CalendarIcon />}
              ...
              <CardContent>
                ...
                <Box sx={{
                  ...
                  <Tooltip title="Platform">
                    <Box>
                      ...
                      <Typography variant="body2">
                        {interview.platform?.replace(/_/g, ' ') || 'No platform'}
                      </Typography>
                    </Box>
                  </Tooltip>
                </Box>
                ...
                <Collapse in={expandedInterview === interview._id} timeout="auto" unmountOnExit>
                  <Box sx={{ mt: 2, pl: 1, pr: 1 }}>
                    ...
                    {/* Job Details — only shown if jobId is not null */}
                    {interview.jobId && (
                      <>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
                      ...
                      <Box sx={{ display: 'flex', gap: 1 }}>
                        ...
                        <Button
                          size="small" variant="contained" endIcon={<MoreIcon />}
