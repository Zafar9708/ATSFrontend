...
//       const response = await axios.get('http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/job', {
//         headers: {
...
//       setIsLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/candidates', {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           'ngrok-skip-browser-warning': 'true'
//         }
...
//       setIsLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/admin/recruiters', {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           'ngrok-skip-browser-warning': 'true'
//         }
...
//       setIsLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/interviews/interviews/schedule', {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           'ngrok-skip-browser-warning': 'true'
//         }
...
//       setIsLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/offline/interviews', {
//         headers: {
//           Authorization: `Bearer ${token}`,
//           'ngrok-skip-browser-warning': 'true'
//         }
