...
const AddCandidateDialog = ({ open, onClose, onAdd, vendors, jobs }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent
        dividers
        sx={{ p: { xs: 2, sm: 3 }, bgcolor: colors.neutral[50] }}
      >
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) =>
                setFormData({ ...formData, matchScore: e.target.value })
              }
    ...
    >
      <CardContent sx={{ p: { xs: 1.5, sm: 2 } }}>
        ...
        >
          ...
          >
            <Icon sx={{ color: colors.primary.main, fontSize: { xs: 20, sm: 24 } }} />
          </Box>
        </Box>
      </CardContent>
    </Card>
...
const CandidateDetailsDialog = ({ open, onClose, candidate }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Grid container spacing={3}>
          ...
          >
            ...
            <Box>
              <Typography
                ...
                sx={{ fontWeight: 600, color: colors.neutral[800] }}
              >
                {candidate.name}
              </Typography>
          ...
          <Grid item xs={12} sm={6}>
            <Typography
              variant="subtitle2"
              sx={{ color: colors.primary.main, fontWeight: 600, mb: 2 }}
            >
              Vendor Information
            </Typography>
            <Stack spacing={1.5}>
              <Box display="flex" alignItems="center" gap={1}>
                <BusinessIcon
                  sx={{ fontSize: "1.2rem", color: colors.primary.main }}
                />
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <Box>
                  <Typography
                    variant="body2"
                    sx={{ color: colors.neutral[600], mb: 1 }}
                  >
                    Technical Skills
                  </Typography>
              ...
              <Grid item xs={12} sm={6}>
                <Box>
                  ...
                  <Typography
                    variant="body1"
                    sx={{ color: colors.neutral[800], fontWeight: 500 }}
                  >
      ...
      <DialogActions
        sx={{ p: 2, justifyContent: "flex-end", bgcolor: colors.neutral[50] }}
      >
...
const VendorCandidatesPage = () => {
  ...
  // Sidebar state - adjust based on screen size
  ...
  // Calculate responsive container dimensions for better tablet support
  const getContainerWidth = () => {
    if (isMobile) return "100%";
    if (isTablet) return "calc(100% - 240px)";
  ...
  const generateMockCandidates = () => {
    ...
    const firstNames = [
      "Emily", "James", "Sarah", "Michael", "Jessica",
      "David", "Lisa", "Robert", "Amanda", "John",
    ];
    const lastNames = [
      "Davis", "Wilson", "Brown", "Taylor", "Anderson",
    ...
    return Array.from({ length: 25 }, (_, i) => {
      ...
      return {
        ...
        skills: ["React", "JavaScript", "TypeScript", "Node.js", "UI/UX", "Product Strategy"]
    ...
    >
      ...
      <Box sx={{ display: "flex", gap: 1.5, mt: 3 }}>
        <Button
          ...
          variant="outlined"
          onClick={() => {
            setTempFilters({ vendor: "all", job: "all", status: "all", dateRange: "all" });
          }}
        >
          Reset
        </Button>
        <Button
          ...
          sx={{ background: colors.primary.gradient, color: "white" }}
        >
          Apply Filters
        </Button>
      </Box>
  ...
  return (
    <>
      ...
      {/* Stats Cards - All cards have equal height and width */}
<Grid container spacing={4} sx={{ mb: 4, px: { xs: 0, md: 2 } }}>
  {[
    ...
    <Grid 
      ...
      md={3}      // 4 cards per row on desktop (equal width: 25%)
      lg={3}      // Maintain 4 cards on large screens
      key={i} 
      sx={{ 
        display: 'flex',
        flexGrow: 1,
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Active Filters - Visible on tablet and desktop */}
            ...
            <Box sx={{ mt: 2, display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }}>
              ...
              {vendorFilter !== "all" && (
                <Chip
                  ...
                  size="small"
                  sx={{ backgroundColor: colors.primary.bg, color: colors.primary.dark }}
                />
              )}
              {jobFilter !== "all" && (
                <Chip
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
            ...
            <Box display="flex" gap={1}>
              <IconButton size="small" onClick={handleRefresh}>
                <RefreshIcon fontSize="small" sx={{ color: colors.primary.main }} />
              </IconButton>
              <IconButton size="small" onClick={handleExport}>
                <ExportIcon fontSize="small" sx={{ color: colors.primary.main }} />
              </IconButton>
            </Box>
          </Box>
        )}
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: colors.neutral[50] }}>
                ...
                {!isMobile && <TableCell sx={{ fontWeight: 600 }}>Vendor</TableCell>}
                <TableCell sx={{ fontWeight: 600 }}>Job</TableCell>
                {!isMobile && !isTablet && <TableCell sx={{ fontWeight: 600 }}>Date</TableCell>}
                  ...
                  <TableCell>
                    <Box display="flex" alignItems="center" gap={1}>
                      ...
                      <Box>
                        <Typography
                          variant="body2"
                          sx={{ fontWeight: 500, fontSize: { xs: "0.875rem", sm: "0.9rem" } }}
                        >
                          {candidate.name}
                        </Typography>
                        <Typography
        ...
        {filteredCandidates.length === 0 && (
          <Box sx={{ textAlign: "center", py: { xs: 6, sm: 8 }, px: 2 }}>
            <PersonIcon sx={{ fontSize: { xs: 48, sm: 60 }, color: colors.neutral[300], mb: 2 }} />
