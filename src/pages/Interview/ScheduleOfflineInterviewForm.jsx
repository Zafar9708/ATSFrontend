...
// // const API_BASE = "http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/offline/interviews";
...
//                             const res = await axios.get("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/interviews/timezones",{
//                                 headers:{
...
//                         try {
//                             const res = await axios.get("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/interviewers");
//                             return res.data;
//                         } catch (error) {
...
//                         try {
//                             const res = await axios.get("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/email-templates");
//                             return res.data;
//                         } catch (error) {
...
//                         try {
//                             const token=localStorage.getItem('token')
//                             const res = await axios.get("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/offline/interviews/utils/rounds",{
//                                 headers:{
//                                     Authorization:`Bearer ${token}`
//                                 }
//                             });
...
//             setLoading(true);
//             const token=localStorage.getItem('token')
//             const response = await axios.post("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/interviewers",{
//                 headers:{
//                     Authorization:`Bearer ${token}`
//                 }
//             }, newInterviewer);
...
//             const token=localStorage.getItem('token')
//             const response = await axios.post("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/offline/interviews/", requestData, {
//                 headers: {
//                     Authorization:`Bearer ${token}`,
...
const ScheduleOfflineInterviewForm = ({ open, onClose, candidate, user }) => {
    ...
    const handleAddInterviewer = async () => {
        ...
        try {
            setLoading(true);
            const token = localStorage.getItem('token');
            const response = await axios.post("http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/interviewers", newInterviewer, {
                headers: {
                    Authorization: `Bearer ${token}`,
                   'ngrok-skip-browser-warning': 'true'
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://ats-env.eba-qmshqp3j.ap-south-1.elasticbeanstalk.com/api/v1/offline/interviews/",
                requestData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
