...
const SuperAdminDashboard = () => {
  ...
  return (
    <Box sx={{ minHeight:'100vh', background:T.bg, p:{ xs:1.5, sm:2.5, md:3 } }}>
      ...
      {/* ════════════════════════════════════════════════════════════════
          ADD ORGANISATION DIALOG  — 3-step form (improved UI)
      ════════════════════════════════════════════════════════════════ */}
      <Dialog
        open={addOpen}
        onClose={() => { setAddOpen(false); resetForm(); }}
        maxWidth="md" fullWidth
        PaperProps={{ sx:{ borderRadius:'28px', overflow:'hidden', p:0, boxShadow:'0 32px 80px rgba(15,23,42,0.28)' } }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', mb:2.5 }}>
            <Box sx={{ display:'flex', alignItems:'center', gap:2 }}>
              <Box sx={{
                p:1.2, borderRadius:'14px', background:'rgba(255,255,255,0.18)',
                display:'flex', boxShadow:'0 2px 12px rgba(0,0,0,0.15)'
              }}>
                <BusinessIcon sx={{ color:'#fff', fontSize:26 }} />
              </Box>
              <Box>
                <Typography sx={{ fontWeight:800, fontSize:20, color:'#fff', lineHeight:1.2, letterSpacing:-.3 }}>
                  New Organisation
                </Typography>
            ...
            <IconButton
              ...
              sx={{
                color:'rgba(255,255,255,0.75)', p:.7, borderRadius:'10px',
                ...
                <React.Fragment key={label}>
                  <Box sx={{ display:'flex', flexDirection:'column', alignItems:'center', gap:.6 }}>
                    <Box sx={{
                      ...
                      background: done    ? 'rgba(255,255,255,0.9)'
                                : current ? '#fff'
                                :           'rgba(255,255,255,0.2)',
                      color:      done    ? T.indigo
                                : current ? T.indigo
                                :           'rgba(255,255,255,0.55)',
                      boxShadow:  current ? '0 0 0 4px rgba(255,255,255,0.25)' : 'none',
                      transition: 'all .3s',
                    }}>
                      {done ? '✓' : idx + 1}
                    </Box>
                    <Typography sx={{
                      ...
                      color: current ? '#fff' : done ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.5)',
                      whiteSpace:'nowrap',
                    }}>
                      {label}
                    </Typography>
                  ...
                  {idx < STEPS.length - 1 && (
                    <Box sx={{
                      flex:1, height:2, mx:1.5, mb:3,
                      background: idx < activeStep ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.2)',
        ...
        {/* ── Form body ───────────────────────────────────────────── */}
        <Box sx={{ px:4, py:3.5, maxHeight:'62vh', overflowY:'auto',
          ...
          {activeStep === 0 && (
            <Box sx={{ display:'flex', flexDirection:'column', gap:3 }}>
              ...
              {/* Step badge */}
              <Box sx={{ display:'flex', alignItems:'center', gap:1.5, pb:2, borderBottom:`2px dashed ${T.border}` }}>
                <Box sx={{ p:1, borderRadius:'12px', background:`${T.indigo}12`, display:'flex' }}>
                  <BusinessIcon sx={{ fontSize:20, color:T.indigo }} />
                </Box>
                <Box>
                  <Typography sx={{ fontWeight:700, fontSize:15, color:T.navy }}>Company Information</Typography>
                  <Typography sx={{ fontSize:12, color:T.muted }}>Basic details about the organisation</Typography>
                </Box>
              </Box>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    Organisation Name <span style={{ color:T.rose }}>*</span>
                  </Typography>
                  <TextField fullWidth name="name" value={form.name} onChange={handleInput}
                    error={!!formErrors.name} helperText={formErrors.name}
                    placeholder="e.g. Kludrac Group"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><BusinessIcon sx={{ fontSize:18, color: formErrors.name ? T.rose : T.indigo }} /></InputAdornment>,
                      sx: {
                        borderRadius:'12px', background: formErrors.name ? '#FFF1F2' : '#F8FAFC',
                        fontSize:14.5, fontWeight:500,
                        '& input': { py:1.6, px:.5 },
                      }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.name ? T.rose : T.border, borderWidth: formErrors.name ? 1.5 : 1 },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    Domain <span style={{ color:T.rose }}>*</span>
                  </Typography>
                  <TextField fullWidth name="domain" value={form.domain} onChange={handleInput}
                    error={!!formErrors.domain} helperText={formErrors.domain}
                    placeholder="e.g. kloudrac.com"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><LanguageIcon sx={{ fontSize:18, color: formErrors.domain ? T.rose : T.indigo }} /></InputAdornment>,
                      sx: { borderRadius:'12px', background: formErrors.domain ? '#FFF1F2' : '#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.domain ? T.rose : T.border },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  ...
                  <TextField fullWidth name="email" type="email" value={form.email} onChange={handleInput}
                    error={!!formErrors.email} helperText={formErrors.email}
                    placeholder="e.g. admin@kloudrac.com"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><EmailIcon sx={{ fontSize:18, color: formErrors.email ? T.rose : T.indigo }} /></InputAdornment>,
                      sx: { borderRadius:'12px', background: formErrors.email ? '#FFF1F2' : '#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.email ? T.rose : T.border },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    Company Phone <span style={{ color:T.rose }}>*</span>
                  </Typography>
                  <TextField fullWidth name="companyPhone" value={form.companyPhone} onChange={handleInput}
                    error={!!formErrors.companyPhone} helperText={formErrors.companyPhone}
                    placeholder="e.g. 9876543210"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><PhoneIcon sx={{ fontSize:18, color: formErrors.companyPhone ? T.rose : T.indigo }} /></InputAdornment>,
                      sx: { borderRadius:'12px', background: formErrors.companyPhone ? '#FFF1F2' : '#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.companyPhone ? T.rose : T.border },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
                </Grid>
              </Grid>

              {/* Row 3 — Industry + Company Size (FULL WIDTH each) */}
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                  ...
                  <FormControl fullWidth error={!!formErrors.industry}>
                    <Select
                      ...
                      renderValue={v => v || <span style={{ color:T.muted, fontSize:14 }}>Select industry…</span>}
                      sx={{
                        borderRadius:'12px', background: formErrors.industry ? '#FFF1F2' : '#F8FAFC',
                        fontSize:14.5, fontWeight:500,
                        '& .MuiSelect-select':{ py:1.6, px:1.8 },
                        '& fieldset':{ borderColor: formErrors.industry ? T.rose : T.border },
                        '&:hover fieldset':{ borderColor:T.indigo },
                        '&.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:'2px !important' },
                      }}>
                      {INDUSTRY_OPTIONS.map(o => (
                        <MenuItem key={o} value={o} sx={{ fontSize:14, fontWeight:500, py:1.2 }}>{o}</MenuItem>
                      ))}
                    </Select>
                    {formErrors.industry && (
                      <Typography sx={{ fontSize:12, color:T.rose, mt:.5, ml:.5 }}>{formErrors.industry}</Typography>
                    )}
                  </FormControl>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    Company Size <span style={{ color:T.rose }}>*</span>
                  </Typography>
                  <FormControl fullWidth error={!!formErrors.companySize}>
                    <Select
                      ...
                      renderValue={v => v || <span style={{ color:T.muted, fontSize:14 }}>Select size…</span>}
                      sx={{
                        borderRadius:'12px', background: formErrors.companySize ? '#FFF1F2' : '#F8FAFC',
                        fontSize:14.5, fontWeight:500,
                        '& .MuiSelect-select':{ py:1.6, px:1.8 },
                        '& fieldset':{ borderColor: formErrors.companySize ? T.rose : T.border },
                        '&:hover fieldset':{ borderColor:T.indigo },
                        '&.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:'2px !important' },
                      }}>
                      {SIZE_OPTIONS.map(o => (
                    ...
                    {formErrors.companySize && (
                      <Typography sx={{ fontSize:12, color:T.rose, mt:.5, ml:.5 }}>{formErrors.companySize}</Typography>
                    )}
                  </FormControl>
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    Website <Typography component="span" sx={{ fontSize:11, color:T.muted, fontWeight:400 }}>(optional)</Typography>
                  </Typography>
                  <TextField fullWidth name="website" value={form.website} onChange={handleInput}
                    placeholder="e.g. https://kloudrac.com"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><LanguageIcon sx={{ fontSize:18, color:T.muted }} /></InputAdornment>,
                      sx: { borderRadius:'12px', background:'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor:T.border },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
                ...
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                    GST Number <Typography component="span" sx={{ fontSize:11, color:T.muted, fontWeight:400 }}>(optional)</Typography>
                  </Typography>
                  <TextField fullWidth name="gstNumber" value={form.gstNumber} onChange={handleInput}
                    placeholder="e.g. 22AAAAA0000A1Z5"
                    InputProps={{
                      sx: { borderRadius:'12px', background:'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } }
                    }}
                    sx={{ '& fieldset':{ borderColor:T.border },
                         '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.indigo },
                         '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.indigo, borderWidth:2 } }} />
          ...
          {activeStep === 1 && (
            <Box sx={{ display:'flex', flexDirection:'column', gap:3 }}>
              ...
              <Box sx={{ display:'flex', alignItems:'center', gap:1.5, pb:2, borderBottom:`2px dashed ${T.border}` }}>
                <Box sx={{ p:1, borderRadius:'12px', background:`${T.sky}15`, display:'flex' }}>
                  <LocationIcon sx={{ fontSize:20, color:T.sky }} />
                </Box>
                <Box>
                  <Typography sx={{ fontWeight:700, fontSize:15, color:T.navy }}>Company Address</Typography>
                  <Typography sx={{ fontSize:12, color:T.muted }}>Registered office address details</Typography>
                </Box>
              </Box>
              ...
              <Box>
                <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>
                  Street Address <span style={{ color:T.rose }}>*</span>
                </Typography>
                <TextField fullWidth name="street" value={form.street} onChange={handleInput}
                  error={!!formErrors.street} helperText={formErrors.street}
                  placeholder="e.g. Sector 62, Block A"
                  InputProps={{
                    startAdornment: <InputAdornment position="start"><LocationIcon sx={{ fontSize:18, color: formErrors.street ? T.rose : T.sky }} /></InputAdornment>,
                    sx: { borderRadius:'12px', background: formErrors.street ? '#FFF1F2' : '#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                  }}
                  sx={{ '& fieldset':{ borderColor: formErrors.street ? T.rose : T.border },
                       '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.sky },
                       '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.sky, borderWidth:2 } }} />
              </Box>

              {/* City + State */}
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>City <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="city" value={form.city} onChange={handleInput}
                    error={!!formErrors.city} helperText={formErrors.city} placeholder="e.g. Noida"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.city ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.city ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.sky }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.sky, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>State <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="state" value={form.state} onChange={handleInput}
                    error={!!formErrors.state} helperText={formErrors.state} placeholder="e.g. Uttar Pradesh"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.state ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.state ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.sky }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.sky, borderWidth:2 } }} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>Country <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="country" value={form.country} onChange={handleInput}
                    error={!!formErrors.country} helperText={formErrors.country} placeholder="e.g. India"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.country ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.country ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.sky }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.sky, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>Zip / Postal Code <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="zipCode" value={form.zipCode} onChange={handleInput}
                    error={!!formErrors.zipCode} helperText={formErrors.zipCode} placeholder="e.g. 201301"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.zipCode ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.zipCode ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.sky }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.sky, borderWidth:2 } }} />
                </Grid>
              </Grid>

              {/* Map pin decorative hint */}
              <Box sx={{ display:'flex', alignItems:'center', gap:1, p:1.8, borderRadius:'12px', background:`${T.sky}0D`, border:`1px dashed ${T.sky}55` }}>
                <LocationIcon sx={{ color:T.sky, fontSize:18, flexShrink:0 }} />
                <Typography sx={{ fontSize:12, color:T.sky, fontWeight:500 }}>
                  Ensure the address is accurate — it will appear on all official communications.
                </Typography>
              </Box>
            </Box>
          )}
          ...
          {activeStep === 2 && (
            <Box sx={{ display:'flex', flexDirection:'column', gap:3 }}>
              ...
              <Box sx={{ display:'flex', alignItems:'center', gap:1.5, pb:2, borderBottom:`2px dashed ${T.border}` }}>
                <Box sx={{ p:1, borderRadius:'12px', background:`${T.emerald}15`, display:'flex' }}>
                  <PersonIcon sx={{ fontSize:20, color:T.emerald }} />
                </Box>
                <Box>
                  <Typography sx={{ fontWeight:700, fontSize:15, color:T.navy }}>Admin Details</Typography>
                  <Typography sx={{ fontSize:12, color:T.muted }}>Primary administrator account credentials</Typography>
                </Box>
              </Box>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>First Name <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="adminFirstName" value={form.adminFirstName} onChange={handleInput}
                    error={!!formErrors.adminFirstName} helperText={formErrors.adminFirstName} placeholder="e.g. Atul"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><PersonIcon sx={{ fontSize:18, color: formErrors.adminFirstName ? T.rose : T.emerald }} /></InputAdornment>,
                      sx:{ borderRadius:'12px', background: formErrors.adminFirstName ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.adminFirstName ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.emerald }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.emerald, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>Last Name <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="adminLastName" value={form.adminLastName} onChange={handleInput}
                    error={!!formErrors.adminLastName} helperText={formErrors.adminLastName} placeholder="e.g. Singhal"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.adminLastName ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.adminLastName ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.emerald }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.emerald, borderWidth:2 } }} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={2.5}>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>Admin Phone <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="adminPhone" value={form.adminPhone} onChange={handleInput}
                    error={!!formErrors.adminPhone} helperText={formErrors.adminPhone} placeholder="e.g. 9876543210"
                    InputProps={{
                      startAdornment: <InputAdornment position="start"><PhoneIcon sx={{ fontSize:18, color: formErrors.adminPhone ? T.rose : T.emerald }} /></InputAdornment>,
                      sx:{ borderRadius:'12px', background: formErrors.adminPhone ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:.5 } }
                    }}
                    sx={{ '& fieldset':{ borderColor: formErrors.adminPhone ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.emerald }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.emerald, borderWidth:2 } }} />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography sx={{ fontSize:12, fontWeight:600, color:T.slate, mb:.8, letterSpacing:.2 }}>Admin Password <span style={{ color:T.rose }}>*</span></Typography>
                  <TextField fullWidth name="adminPassword" type="password" value={form.adminPassword} onChange={handleInput}
                    error={!!formErrors.adminPassword} helperText={formErrors.adminPassword || 'Minimum 8 characters'}
                    placeholder="Min. 8 characters"
                    InputProps={{ sx:{ borderRadius:'12px', background: formErrors.adminPassword ? '#FFF1F2':'#F8FAFC', fontSize:14.5, fontWeight:500, '& input':{ py:1.6, px:1.8 } } }}
                    sx={{ '& fieldset':{ borderColor: formErrors.adminPassword ? T.rose : T.border }, '& .MuiOutlinedInput-root:hover fieldset':{ borderColor:T.emerald }, '& .MuiOutlinedInput-root.Mui-focused fieldset':{ borderColor:T.emerald, borderWidth:2 } }} />
                </Grid>
              </Grid>

              {/* Review summary card */}
              <Box sx={{ borderRadius:'16px', border:`1px solid #BBF7D0`, overflow:'hidden', mt:.5 }}>
                <Box sx={{ px:2.5, py:1.5, background:'#F0FDF4', borderBottom:'1px solid #BBF7D0' }}>
                  <Typography sx={{ fontSize:12, fontWeight:700, color:'#065F46', letterSpacing:.3 }}>
                    ✅ Review Summary
                  </Typography>
                </Box>
                <Box sx={{ p:2, display:'grid', gridTemplateColumns:'1fr 1fr', gap:1 }}>
                  {[
                    ...
                    <Box key={k} sx={{ display:'flex', flexDirection:'column', gap:.2 }}>
                      <Typography sx={{ fontSize:10, color:'#047857', fontWeight:700, textTransform:'uppercase', letterSpacing:.5 }}>{k}</Typography>
                      <Typography sx={{ fontSize:13, color: v ? '#065F46' : T.muted, fontWeight:500 }}>
                        {v || '—'}
                      </Typography>
                    </Box>
                  ))}
        ...
        <Box sx={{
          ...
          {/* Step indicator text */}
          <Typography sx={{ fontSize:12, color:T.muted, flex:1, fontWeight:500 }}>
            Step <b style={{ color:T.navy }}>{activeStep + 1}</b> of <b style={{ color:T.navy }}>{STEPS.length}</b>
          </Typography>

          <Button
            onClick={activeStep === 0 ? () => { setAddOpen(false); resetForm(); } : handleBack}
            startIcon={activeStep > 0 ? <PrevIcon /> : null}
            sx={{
              borderRadius:'12px', textTransform:'none', fontWeight:600, px:3, py:1.3,
              fontSize:14, color:T.slate, border:`1.5px solid ${T.border}`,
              background:'#fff',
              '&:hover':{ background:T.bg, borderColor:T.slate }
            }}>
          ...
          {activeStep < STEPS.length - 1 ? (
            <Button onClick={handleNext} variant="contained"
              endIcon={<NextIcon />}
              sx={{
                borderRadius:'12px', textTransform:'none', fontWeight:700, px:3.5, py:1.3,
                fontSize:14, background:T.indigo, boxShadow:`0 4px 18px ${T.indigo}45`,
                '&:hover':{ background:T.indigoL, boxShadow:`0 6px 22px ${T.indigo}55` }
              }}>
              Continue
            </Button>
          ) : (
            <Button onClick={handleSubmit} variant="contained" disabled={submitting}
              sx={{
                ...
                fontSize:14, background:T.indigo, boxShadow:`0 4px 18px ${T.indigo}45`,
                '&:hover':{ background:T.indigoL },
                '&:disabled':{ background:`${T.indigo}55`, color:'rgba(255,255,255,0.65)' }
              }}>
              {submitting ? 'Creating…' : '🚀 Register Organisation'}
            </Button>
          )}
