...
const SuperAdminDashboard = () => {
  ...
  return (
    <Box sx={{ p: 1, minHeight: '100vh',  backgroundColor: theme.palette.background.default,  mr:5 }}>
      ...
      {/* Add Tenant Dialog */}
      <Dialog open={addDialogOpen} onClose={handleAddDialogClose} maxWidth="md" fullWidth PaperProps={{ sx: { borderRadius: 3, p: 3, maxHeight: '90vh' } }}>
        <DialogTitle sx={{ fontWeight: 700, p: 0, mb: 3 }}>Register New Company</DialogTitle>
        ...
        <form onSubmit={handleSubmit}>
          <DialogContent sx={{ p: 0, maxHeight: '60vh', overflowY: 'auto' }}>
            ...
            <Accordion expanded={expandedAccordion === 'basic'} onChange={handleAccordionChange('basic')} sx={{ mb: 2, borderRadius: 2, boxShadow: theme.shadows[1] }}>
              ...
              <AccordionDetails>
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Company Name (Legal Name)*" name="companyName" value={newTenant.companyName} onChange={handleInputChange} error={!!formErrors.companyName} helperText={formErrors.companyName} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Trade Name / Brand Name" name="tradeName" value={newTenant.tradeName} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <FormControl sx={{minWidth:180}} fullWidth error={!!formErrors.companyType}>
                      <InputLabel>Company Type*</InputLabel>
                      <Select name="companyType" value={newTenant.companyType} onChange={handleInputChange} label="Company Type*" sx={{ borderRadius: 2 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl sx={{minWidth:180}} fullWidth error={!!formErrors.industryType}>
                      <InputLabel>Industry Type*</InputLabel>
                      <Select name="industryType" value={newTenant.industryType} onChange={handleInputChange} label="Industry Type*" sx={{ borderRadius: 2 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl sx={{minWidth:180}} fullWidth error={!!formErrors.companySize}>
                      <InputLabel>Company Size (No. of employees)*</InputLabel>
                      <Select name="companySize" value={newTenant.companySize} onChange={handleInputChange} label="Company Size (No. of employees)*" sx={{ borderRadius: 2 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Website" name="website" value={newTenant.website} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 }, startAdornment: <InputAdornment position="start">https://</InputAdornment> }} />
                  </Grid>
                </Grid>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expandedAccordion === 'contact'} onChange={handleAccordionChange('contact')} sx={{ mb: 2, borderRadius: 2, boxShadow: theme.shadows[1] }}>
              ...
              <AccordionDetails>
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Registered Office Address*" name="registeredAddress" value={newTenant.registeredAddress} onChange={handleInputChange} error={!!formErrors.registeredAddress} helperText={formErrors.registeredAddress} variant="outlined" multiline rows={3} InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Corporate Office Address (if different)" name="corporateAddress" value={newTenant.corporateAddress} onChange={handleInputChange} variant="outlined" multiline rows={3} InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="State*" name="state" value={newTenant.state} onChange={handleInputChange} error={!!formErrors.state} helperText={formErrors.state} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="City*" name="city" value={newTenant.city} onChange={handleInputChange} error={!!formErrors.city} helperText={formErrors.city} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Pincode*" name="pincode" value={newTenant.pincode} onChange={handleInputChange} error={!!formErrors.pincode} helperText={formErrors.pincode} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Phone / Mobile Number*" name="phone" value={newTenant.phone} onChange={handleInputChange} error={!!formErrors.phone} helperText={formErrors.phone} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Company Email*" name="email" type="email" value={newTenant.email} onChange={handleInputChange} error={!!formErrors.email} helperText={formErrors.email} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Primary Contact Person*" name="contactPerson" value={newTenant.contactPerson} onChange={handleInputChange} error={!!formErrors.contactPerson} helperText={formErrors.contactPerson} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                </Grid>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expandedAccordion === 'statutory'} onChange={handleAccordionChange('statutory')} sx={{ mb: 2, borderRadius: 2, boxShadow: theme.shadows[1] }}>
              ...
              <AccordionDetails>
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="PAN (Permanent Account Number)" name="pan" value={newTenant.pan} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="GSTIN" name="gstin" value={newTenant.gstin} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="CIN (Corporate Identification Number)" name="cin" value={newTenant.cin} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="TAN (Tax Deduction Account Number)" name="tan" value={newTenant.tan} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="MSME / Udyam Registration Number" name="msmeUdyam" value={newTenant.msmeUdyam} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Shop & Establishment Number" name="shopEstablishment" value={newTenant.shopEstablishment} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="PF Registration Number" name="pfRegistration" value={newTenant.pfRegistration} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="ESI Registration Number" name="esiRegistration" value={newTenant.esiRegistration} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                </Grid>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion expanded={expandedAccordion === 'banking'} onChange={handleAccordionChange('banking')} sx={{ mb: 2, borderRadius: 2, boxShadow: theme.shadows[1] }}>
              ...
              <AccordionDetails>
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Bank Name" name="bankName" value={newTenant.bankName} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Account Holder Name" name="accountHolderName" value={newTenant.accountHolderName} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Account Number" name="accountNumber" value={newTenant.accountNumber} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="IFSC Code" name="ifscCode" value={newTenant.ifscCode} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12}>
                    <TextField fullWidth label="Billing Address" name="billingAddress" value={newTenant.billingAddress} onChange={handleInputChange} variant="outlined" multiline rows={3} InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="Billing Contact Email" name="billingEmail" type="email" value={newTenant.billingEmail} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField fullWidth label="GST Billing State" name="gstBillingState" value={newTenant.gstBillingState} onChange={handleInputChange} variant="outlined" InputProps={{ sx: { borderRadius: 2 } }} />
                  </Grid>
                </Grid>
              </AccordionDetails>
            </Accordion>
          ...
          <DialogActions sx={{ p: 0, mt: 3, justifyContent: 'flex-end' }}>
            <Button onClick={handleAddDialogClose} variant="outlined" sx={{ borderRadius: 2, textTransform: 'none', px: 3, py: 1, mr: 2, borderColor: theme.palette.divider }}>
              Cancel
            </Button>
            <Button type="submit" variant="contained" sx={{ borderRadius: 2, textTransform: 'none', px: 3, py: 1, backgroundColor: theme.palette.primary.main }}>
              Register Company
            </Button>
          </DialogActions>
        </form>
