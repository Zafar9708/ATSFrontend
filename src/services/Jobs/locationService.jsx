...
// const API_BASE_URL = 'http://ats-env.eba-9hjpmsgu.us-east-1.elasticbeanstalk.comapi/v1/location';
...
const API_BASE_URL = 'http://ats-env.eba-9hjpmsgu.us-east-1.elasticbeanstalk.com/api/v1/location';
const getAuthHeaders = () => {
  const token = localStorage.getItem('token');
  return {
    headers: {
